...
class CalculatorTest {
    ...
    void exercise1() {
        System.out.println("\nExercise 1: ");
        // Your code here
        Calculator logitech = new Calculator();
        Assertions.assertEquals(10, logitech.add(5,5));
        Assertions.assertEquals(-10, logitech.add(-5,-5));
        Assertions.assertEquals(0, logitech.subtract(5,5));
    }
    ...
    void exercise3() {
        ...
        Assertions.assertEquals(125, c.power( 5, 3));
        Assertions.assertEquals(0.04, c.power( 5, -2)); // --> esponente con numero negativo diventa 1/( 5*(esponente) )
        Assertions.assertEquals(0.008, c.power( 5, -3)); // --> esponente con numero negativo diventa 1/( 5*(esponente) )
        Assertions.assertEquals(166.375, c.power( 5.5, 3));
        Assertions.assertEquals(1, c.power( 1, 0));

        Assertions.assertTrue(Double.isInfinite(c.power(0, -1))); // --> assertTrue ritorna un booleano
        Assertions.assertTrue(Double.isInfinite(c.power(-0, -1)));
        Assertions.assertFalse(Double.isInfinite(c.power(-0, 1)));
        Assertions.assertFalse(Double.isInfinite(c.power(0, 1)));
    }
}